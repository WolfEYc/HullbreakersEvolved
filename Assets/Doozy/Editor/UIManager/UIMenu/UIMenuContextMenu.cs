    ...
    public static class UIMenuContextMenu
    {
        ...
        public static class Components
        {
            ...
            public static class Buttons
            {
                ...
                [MenuItem(CATEGORY_MENU_PATH + "Difficulty", false, MENU_ITEM_PRIORITY)]
                public static void CreateDifficulty(MenuCommand command) => UIMenuUtils.AddToScene(TYPE_NAME, CATEGORY_NAME, "Difficulty");
            }
